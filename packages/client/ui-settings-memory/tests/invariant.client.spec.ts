...
import * as MemoryInvariant from '@deepseek-ai/dsh-client-ui-settings-memory/invariant'
...
describe('invariant companion', () => {
  ...
  it('node-half apply is a no-op host placeholder', async () => {
    const { apply } = await import('@deepseek-ai/dsh-client-ui-settings-memory')
    apply()
    expect(true).toBe(true) // reaching here without throw is the contract
  })

  it('renders null until the shell injects the section dependencies', () => {
    expect(MemorySection({})).toBeNull()
  })
})
