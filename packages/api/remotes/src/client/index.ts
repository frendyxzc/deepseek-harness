...
export type { FeishuStatusView } from '@deepseek-ai/dsh-feishu-status/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, feishuStatusRemote, messageFeedbackRemote,
    ]) {
