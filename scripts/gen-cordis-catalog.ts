...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  FeishuCardActionEvent: 'feishu.md',
  ...
  FeishuReceiveEvent: 'feishu.md',
  FeishuReceiveHandler: 'feishu.md',
  FeishuReceiveIdType: 'feishu.md',
  FeishuRuntimeConfig: 'feishu.md',
  FeishuRuntimeStatus: 'feishu.md',
  FeishuSendRequest: 'feishu.md',
  FeishuSendResult: 'feishu.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TdaiIdentity: 'per-bot team/agent identity is owned by packages/llm/tdai-memory/README.md',
  TdaiTeamOption: 'core catalog team option is owned by packages/llm/tdai-memory/README.md',
  TdaiAgentOption: 'core catalog agent option is owned by packages/llm/tdai-memory/README.md',
